...
class TLDetector(object):
    ...
    # split waypoint to x and y coordinates
    def waypoint_cord_xy(self, waypoint):
    ...
    def waypoints_cb(self, waypoints):
        ...
        if not self.waypoints_2d:
            self.waypoints_2d = [self.waypoint_cord_xy(waypoint) for waypoint in waypoints.waypoints]
